...
![Pair Plot (left) and Correlation Heatmap (right) for Numerical Variables]()
...
![Correlation Heatmap for Product Spending (left) and Offer Acceptances (right)]()
...
![Scree Plot and Components Importance for Spending Behaviour (left) and Offer Acceptances (right)]()
...
![Biplot and Component Loadings for Spending Behaviour (left) and Offer Acceptances (right)]()
...
![Cluster Plot (top) and Cluster Details (bottom) at K=3]()
...
![Customer Count by Cluster and Income Level, and Customer Count by Cluster and Income Level]()
...
![Promo Purchases Distribution based on Customer Segments]()
...
![Total Acceptances by Offer and Cluster (left) and Total Purchases by Cluster and Channel (right)]()
